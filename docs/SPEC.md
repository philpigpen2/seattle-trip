...
Design: warm off-white app library, dark ink, modest gold arcade identity. Compact masthead, clear welcome/title and account controls; grouped lists with simple horizontal dividers, untiled icons and useful descriptions; search + category controls and recoverable empty state. Retain all ten destinations. Link to /arcade without signing out. Public entry retains games; add plainly named sign-in action. No new backend or data writes.
...
User correction (16 September 2026): “I hate card designs. No cards.” Follow-up: “I like your groupsings though. They work well.” Keep Everyday / Create & play / Projects. Use unboxed rows on desktop and phone, plain underlined category controls, no card backgrounds, enclosing borders, shadows or lift effects.
